...
<body>
  ...
  <section class="hero-container">
    <main class="hero-content-wrapper">
      <h1 id="dark">Neem contact met ons op!</h1>
      <p id="dark2">Wil jij contact met ons opnemen? Vul het formulier in en we helpen je graag verder.</p>
      <article class="hero-button-container">
        <a href="../">Home</a>
        <a id="h-btn-2" href="../kamers/">Kamers</a>
      </article>
    </main>
  </section>
      ...
      <main class="box">
        ...
        <section>
          <ul>
            ...
            <li class="hovericon"><a href="https://www.google.com/maps?q=ict+vanaf+morgen+alkmaar"><i class="fas fa-location-dot my-icon"></i> Straatnaam 85 1234 AB Alkmaar NL</a></li>
            <li class="hovericon"><a href="tel:0724145343"><i class="fas fa-phone my-icon"></i> 072 41 45 343</a></li>
            <li class="hovericon"><a href="mailto:info@hotelzon.nl"><i class="fas fa-envelope my-icon"></i> info@hotelzon.nl</a></li>
          </ul>
        </section>
      </main>
    </section>
